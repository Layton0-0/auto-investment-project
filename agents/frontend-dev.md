...
- .cursor/rules/frontend-react-ts.md 준수
- 보안: dangerouslySetInnerHTML 금지, 입력 검증, 토큰 노출 금지

## Applicable project rules (역할별 준수 규칙)
- **frontend-react-ts.md** — 컴포넌트·상태·훅·타입 규칙
- **frontend-react-ts.md** — XSS·입력검증·토큰·CSRF
- **monorepo-boundaries.md** — smart-portfolio-pal 수정 금지, 참조만
- **security-baseline.md** — 클라이언트 보안·민감데이터 미노출
