...
- **quant-and-backtest.md** — 자본 보존, 로버스트니스, 백테스트·리스크·실행 원칙
- **docs-and-quality.md** — 전략·팩터 변경 시 00-strategy-registry.md·버전 스택 갱신
- **korea-investment-api.md** — 한국투자증권 시세·차트 등 API 사용 시 MCP 참조
